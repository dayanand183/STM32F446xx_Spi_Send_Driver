...
void SPI_DataSend(SPI_RegDef_t *pSPIx, uint8_t *pTxBuffer, uint32_t len)
{
	while(len > 0)
	{
		...
		// 2. check the DFF bit int the CR1
...
uint8_t SPI_GetFlagStaus(SPI_RegDef_t *pSPIx, uint32_t FlagName)
{
